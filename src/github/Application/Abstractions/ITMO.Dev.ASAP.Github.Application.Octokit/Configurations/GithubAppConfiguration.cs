...
public class GithubAppConfiguration : IAsapConfiguration
{
    ...
    public string GithubAppSecret { get; init; } = string.Empty;

    public string ServiceOrganizationName { get; init; } = string.Empty;
