...
public class StudentGroupQueryLink : QueryLinkBase<StudentQuery.Builder, StudentQueryParameter>
{
    ...
    {
        return parameter.Type is not StudentQueryParameter.Group
            ? null
            : queryBuilder.WithGroupNamePattern(parameter.Pattern);
    }
}